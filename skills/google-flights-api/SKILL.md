...
description: "Google Flights route search by date as structured JSON: price, airline, total duration, stops and per-leg detail across best_flights and other_flights. Round-trip, one-way and multi-city, with cabin class, stops, airline and sort filters. One endpoint on the v2 engine, 1 credit per request."
version: 1.0.0
tags: google-flights, google-flights-api, flight-search, airfare, flight-prices, airlines, itinerary, travel, price-tracking, multi-city, langchain, crewai, autogen, structured-data, json, ai-agents
metadata:
  openclaw:
    requires:
      env:
    ...
    throttle: 1
    emoji: "\U00002708"
    homepage: https://scavio.dev/docs/google-flights?utm_source=agent-skills&utm_medium=skill&utm_campaign=google-flights-api
---
...
# Your key from https://scavio.dev/?utm_source=agent-skills&utm_medium=skill&utm_campaign=google-flights-api. Load it from your environment or secret
...
- `429` means rate or usage limit exceeded. Wait before retrying. See https://scavio.dev/docs/rate-limits?utm_source=agent-skills&utm_medium=skill&utm_campaign=google-flights-api.
