...
description: Pull Weibo user profiles and posts, post comments/likes/reposts, keyword search across posts, videos, users, topics and images, and the hot-search and ranking boards. 30 endpoints, 1 credit each, structured JSON.
version: 1.0.0
...
1. Sign up at [dashboard.scavio.dev](https://dashboard.scavio.dev/sign-up?utm_source=agent-skills&utm_medium=skill&utm_campaign=weibo-scraper-api) - email or Google, no card required.
